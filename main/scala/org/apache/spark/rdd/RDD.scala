...
abstract class RDD[T: ClassTag](
  ...
  var isSchedule = false     // use to check if a job concluded this rdd is scheduled by Global Scheduler
  var newRDD: RDD[_] = this  // if this rdd is cached by other app, it will be replaced by this newRDD
